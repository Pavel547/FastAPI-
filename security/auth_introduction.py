...
def create_access_token(data: dict, expirec_delta: timedelta | None = None):
    to_encode = data.copy()
    if expirec_delta:
        expire = datetime.now(timezone.utc) + expirec_delta
    else:
...
async def login_for_acces_token(
    ...
    access_token = create_access_token(
        data={"sub": user.username}, expirec_delta=access_token_expires
    )
